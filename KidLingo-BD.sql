...
-- TABELA ATIVIDADES: Implementação do Quiz 
...
-- 2. Tabela para rastrear o progresso do usuário (SIMULADO)
...
('Mestre das lições', 'Complete 4 lições no total.', 4, 'licoes'),
('Novato Pontuador', 'Alcance 50 pontos.', 50, 'pontos'),
('Aprendiz Veloz', 'Acumule 10 minutos (600s) de estudo.', 600, 'tempo');

-- 4. Inserir um registro inicial de progresso (simulado)
