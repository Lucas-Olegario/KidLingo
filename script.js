// script.js (CÓDIGO COMPLETO E ATUALIZADO)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.getElementById("lessons-screen")) {
        ...
        // Lógica para completar a lição (AGORA SÓ APÓS O QUIZ)
...
// -----------------------------------------------------------------------------------------
// 6. Funcionalidade do Painel de Acompanhamento (painel-acompanhamento.html) (DINÂMICO)
// -----------------------------------------------------------------------------------------
